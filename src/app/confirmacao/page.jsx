  ...
  return (
    ...
    <div className="logo-container cadastro_logo">
        ...
        <div className='menu_opcoes'>
            ...
            <div className="botao_menu_opcoes">
                <a href="" className="btn_menu_opcoes btn_pagina">Turma</a>
                <div class="horizontal-line"></div>
            </div>
            <div className="botao_menu_opcoes">
                <a href="" className="btn_menu_opcoes btn_pagina">Familia</a>
                <div class="horizontal-line"></div>
            </div>
            <div className="botao_menu_opcoes">
                <a href="" className="btn_menu_opcoes btn_pagina">Confirmação</a>
                <div class="horizontal-line"></div>
            </div>
        </div>
